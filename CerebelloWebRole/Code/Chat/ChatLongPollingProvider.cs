...
namespace CerebelloWebRole.Code.Chat
{
    public class ChatLongPollingProvider : LongPollingProvider
    {
        ...
        /// <returns></returns>
        private static LongPollingEvent GetLongPollingEventForMessages([NotNull] IEnumerable<ChatMessage> messages)
        {
        ...
        /// <returns></returns>
        private static LongPollingEvent GetLongPollingEventForRoomUsersChanged([NotNull] IEnumerable<ChatUser> users, int myUserId)
        {
