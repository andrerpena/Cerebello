(function ($) {
    ...
    function Pager(el, options) {
        ...
        if (options.currentPageIndex == null) options.currentPageIndex = undefined;
    ...
    Pager.prototype = {
        ...
        init: function () {
            ...
            _this.$el.html("<a href='#' class='paginator-prev'>&lt;</a><span class='paginator-current-page'>" +
                _this.opts.currentPageIndex + "</span>/<span class='paginator-page-count'>" +
                _this.pageCount +
                "</span><a href='#' class='paginator-next'>&gt;</a>");
