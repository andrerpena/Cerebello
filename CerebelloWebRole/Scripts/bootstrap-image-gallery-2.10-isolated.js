/*
 * Bootstrap Image Gallery 2.10 (isolated)
...
(function (factory) {
    ...
    var originalShow = $.fn.bsmodal.Constructor.prototype.show,
        originalHide = $.fn.bsmodal.Constructor.prototype.hide;
    $.extend($.fn.bsmodal.Constructor.prototype, {
        initLinks: function () {
            var $this = this,
        ...
        showImage: function (img) {
            ...
            modalImage.css({
                width: img.width,
                height: img.height,
                top: (modalBody.height() - img.height) / 2
            });
        ...
        show: function () {
            if (!this.isShown && this.$element.hasClass('modal-gallery')) {
                ...
                } else if (options.constratio) {
                    var ratio = eval(options.constratio),
                        maxWidth = windowWidth - options.offsetWidth,
                        maxHeight = windowHeight - options.offsetHeight,
                        w1 = Math.min(maxWidth, maxHeight * ratio),
                        h1 = Math.min(maxHeight, maxWidth * ratio),
                        w2 = Math.min(w1, w1 * windowHeight / h1),
                        h2 = Math.min(h1, h1 * windowWidth / w1),
                        w3 = Math.ceil(w2),
                        h3 = Math.ceil(h2);
